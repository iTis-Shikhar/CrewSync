  ...
  const handleCreateEvent = async (e) => {
    ...
    try {
      await addDoc(collection(db, "events"), {
        name: eventName, date: eventDate, description: eventDescription, createdAt: new Date()
      });
      // After creating, go back to the event list to see it
      setPage('eventList');
    } catch (err) {
      ...
      <div className="form-container">
        ...
        <form onSubmit={handleCreateEvent}>
          ...
          <div className="form-actions">
            {/* The cancel button now goes back to the main dashboard */}
